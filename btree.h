...
//helper function for insert. It takes in the original root and the 
//number of the child that the new value belongs in.
void split_child(btree*& root, int i);

//another helper function to help insert a value when the node is 
//not full.
